...
export function AuthProvider({ children }) {
  ...
  // ── BUG 1: login() no envía la petición a la API.
  //    Valida los campos pero llama a un endpoint inexistente (/auth/iniciar-sesion)
  //    en lugar del correcto (/auth/login). El usuario nunca puede autenticarse.
